...
// Register a new User
router.post('/register', (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Pass user credentials to controller to be structured, validated, and saved to a database
    let newSavedUser = yield (0, signupController_1.signUserUp)(req.body.email, req.body.password);
